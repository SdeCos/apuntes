...
class Jardinero {
  public static void main(String[] args) {
    ...
    normalTree.printInorder(normalTree.getRoot());
    System.out.println("\n" + "=".repeat(20));
    normalTree.printPostorder(normalTree.getRoot());
    System.out.println("\n" + "=".repeat(20));
    normalTree.printPreorder(normalTree.getRoot());

    // Insercion de datos de diferentee maneras
